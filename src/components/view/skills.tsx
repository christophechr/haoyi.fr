    ...
    return (
        ...
        <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-2 gap-6 py-12 sm:grid-cols-3 lg:grid-cols-4 lg:gap-12">
                ...
                <Skill skillName="Node.js" imageUrl="/icons/nodejs.png" altName="Node.js Icon" desc="A JavaScript runtime built on Chrome's V8 JavaScript engine, handling the server of websites." width={50} height={50}/>
                <Skill skillName="C++" imageUrl="/icons/cplusplus.png" altName="C++ Icon" desc="One of the most powerful object-oriented programming language, mostly used in Video Games." width={50} height={50}/>
